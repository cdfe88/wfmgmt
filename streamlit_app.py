...
def create_roster_fig(demand,resources):
    ...
    figx.add_trace(go.Scatter(x=[demand['Weekday'],demand['Hour']],y=demand['positions'],mode='lines',line=dict(color='#9a9a9a', width=3,shape='hvh'),name='Calculated Demand',legendgroup='A',showlegend=True))
